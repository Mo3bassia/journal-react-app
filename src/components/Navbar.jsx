...
function Navbar({ setLanguage, lang, setIsDark }) {
  return (
    <nav className="py-7 bg-gray-200 text-gray-900 dark:bg-gray-800 dark:text-white">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <ul className="flex items-center gap-2">
          <li>
            <select
              className="px-2 rounded-md py-2 bg-slate-150 border border-gray-400 dark:bg-slate-700 dark:text-slate-50 outline-none"
              value={lang}
